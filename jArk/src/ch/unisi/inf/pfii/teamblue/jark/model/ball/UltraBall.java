...
/**
 * This ball is so powerful it destroys everything it touches, except for the
 * persistent bricks. If the contact with the brick is long enough, it destroys
 * also resistent bricks.
 * 
...
public final class UltraBall extends Ball {
	...
	public final Ball copy() {
		final Ball returnBall = new UltraBall(vaus, level);
