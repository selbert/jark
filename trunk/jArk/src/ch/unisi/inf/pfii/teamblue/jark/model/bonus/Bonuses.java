...
public enum Bonuses {
	...
	LASER (5, "bonus_riflevaus", 4, new RifleVausBonus()),
	ULTRA (6, "bonus_ultraball", 3, new UltraBallBonus()),
	DBL_LASER (7, "bonus_doubleriflevaus", 3, new DoubleRifleVausBonus()),
	MISSILE (8, "bonus_cannonvaus", 2, new CannonVausBonus()),
